...
class Pelanggan extends CI_Controller
{
	...
	public function add()
	{
		...
		$this->data_pelanggan->insert_data($data, 'pelanggan');
	...
	public function edit()
	{
		...
		$this->data_pelanggan->update_data($pelanggan_id, $data, 'pelanggan');
	...
	public function delete()
	{
		...
		$this->data_pelanggan->delete_data($pelanggan_id, 'pelanggan');
