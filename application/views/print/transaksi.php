	...
	<table>
		...
		?>
			<tr>
				...
				<td><?php echo ($transaksi->jenis_layanan === 'kiloan') ? '<span class="badge badge-info">' . $transaksi->berat . ' Kg</span>' : '<span class="badge badge-primary">Satuan</span>' ?></td>
		...
		<tr>
			...
			<td colspan="3"><b>Rp. <?php echo number_format($total_pendapatan, 0, ',', '.') ?></b></td>
		</tr>
	</table>
