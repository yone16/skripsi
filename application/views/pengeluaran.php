            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between">
                        <h4 class="my-auto font-weight-bold text-primary">Data Pengeluaran Uang</h4>
                        <div class="d-flex">
                            <a href="#" class="btn btn-success shadow-sm" data-toggle="modal" data-target="#addPengeluaran"><i class="fas fa-plus fa-sm text-white-500"></i> Add Expenditure</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>Rp.<?php echo number_format($pengeluaran->total, 0, ',', '.') ?></td>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="karyawan_id" required>
                                ...
                                foreach ($data_karyawan as $karyawan) {
                                    if ($karyawan->aktif == 1) {
                                ?>
                                        <option value="<?php echo $karyawan->karyawan_id ?>" <?php if ($karyawan->karyawan_id === $pengeluaran->karyawan_id) {
                                                                                                    echo "selected";
                                                                                                } ?>>
                                            <?php echo $karyawan->karyawan_id . ' ' . $karyawan->nama_karyawan ?>
                                        </option>
